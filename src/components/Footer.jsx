    ...
    <>
      ...
      <footer className="main-container grid md:grid-cols-2 lg:grid-cols-4 gap-10 py-20">
        ...
        <div>
          ...
          <ul className="flex flex-col gap-2 text-base lg:text-lg">
            <li>Available throughout the week.</li>
          ...
          <ul className="flex flex-col gap-2 text-base lg:text-lg">
            <li>
              <a
                ...
                className="transition duration-300 hover:text-white hover:drop-shadow-[0_0_6px_#ffffff]"
              >
                bhakataditya0@gmail.com
              </a>
            </li>
            <li>
              <a
      ...
      <div className="main-container grid md:grid-cols-2 gap-3 py-6 lg:py-8 max-md:text-center">
        <div className="text-base lg:text-lg">
          © 2025 AB | All rights reserved
        </div>
        <div className="flex gap-3 justify-center md:justify-end">
          <a href="https://www.linkedin.com/in/aditya-bhakat-anshu/">
            <svg
              width="30"
              height="30"
              viewBox="0 0 30 30"
          ...
          <a href="https://www.instagram.com/aditya_bhakat69/">
            <svg
              width="30"
              height="30"
              viewBox="0 0 30 30"
          ...
          <a href="https://github.com/Bhakat-Aditya">
            <svg
              width="30"
              height="30"
              viewBox="0 0 50 50"
