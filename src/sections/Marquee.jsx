...
const Marquee = () => {
  return (
    <>
      <div className="overflow-hidden bg-yellow-100 text-black pb-28 lg:pb-44">
        ...
        <div className="whitespace-nowrap animate-marquee text-6xl lg:text-[7vw] font-heading font-semibold leading-[1] tracking-tight">
          <span className="flex gap-4 lg:gap-8 mx-8">
            ...
            VIBE <img src={star} alt="" className="marquee-star1 w-[7vw]" /> 
            MUSIC <img src={star} alt="" className="marquee-star1 w-[7vw]" /> 
            MOVIES <img src={star} alt="" className="marquee-star1 w-[7vw]" /> 
          </span>
        </div>
        ...
        <div className="whitespace-nowrap animate-marquee-reverse text-6xl lg:text-[7vw] font-heading font-semibold leading-[1] tracking-tight">
          <span className="flex gap-4 lg:gap-8 mx-8">
            ...
            VIBE <img src={star} alt="" className="marquee-star2 w-[7vw]" /> 
            MUSIC <img src={star} alt="" className="marquee-star2 w-[7vw]" /> 
            MOVIES <img src={star} alt="" className="marquee-star2 w-[7vw]" /> 
          </span>
        </div>
